        ...
        <div style={{ backgroundColor: '#ffffff', border: '1px solid #e2e8f0', borderRadius: '1rem', padding: '1.75rem', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          ...
          <div style={{ marginBottom: '1.25rem' }}>
            ...
            <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
              <button type="button" onClick={() => setFormData({ consumoMensual: '45', usoHorarioPico: 'false', cantidadEquipos: '2', tipoInmueble: 'Residencial', horasAltoConsumo: '1', metrosCuadrados: '60', cantidadPersonas: '1' })} style={presetBtnStyle}><span style={{ display: 'flex', alignItems: 'center', gap: '0.35rem' }}><Home size={14} /> Casa Eficiente</span></button>
              <button type="button" onClick={() => setFormData({ consumoMensual: '280', usoHorarioPico: 'false', cantidadEquipos: '4', tipoInmueble: 'Residencial', horasAltoConsumo: '4', metrosCuadrados: '90', cantidadPersonas: '3' })} style={presetBtnStyle}><span style={{ display: 'flex', alignItems: 'center', gap: '0.35rem' }}><Store size={14} /> Local Moderado</span></button>
              <button type="button" onClick={() => setFormData({ consumoMensual: '1200', usoHorarioPico: 'true', cantidadEquipos: '12', tipoInmueble: 'Comercial', horasAltoConsumo: '14', metrosCuadrados: '150', cantidadPersonas: '8' })} style={presetBtnStyle}><span style={{ display: 'flex', alignItems: 'center', gap: '0.35rem' }}><Factory size={14} /> Industria Inef.</span></button>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 2fr', gap: '1rem', marginTop: '0.5rem' }}>
              ...
              <button 
                type="submit" 
                style={{ ...btnStyle, backgroundColor: '#059669', color: '#ffffff', fontWeight: 'bold', opacity: loading ? 0.7 : 1, cursor: loading ? 'not-allowed' : 'pointer' }}
                disabled={loading}
              >
                {loading ? (
