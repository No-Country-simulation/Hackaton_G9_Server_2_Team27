        ...
        <div style={{ backgroundColor: '#ffffff', border: '1px solid #e2e8f0', borderRadius: '1rem', padding: '1.75rem', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
          ...
          <div style={{ marginBottom: '1.25rem' }}>
            ...
            <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
              <button type="button" onClick={() => setFormData({ consumoMensual: '45', usoHorarioPico: 'false', cantidadEquipos: '2', tipoInmueble: 'Casa', horasAltoConsumo: '1', metrosCuadrados: '60', cantidadPersonas: '1' })} style={presetBtnStyle}><span style={{ display: 'flex', alignItems: 'center', gap: '0.35rem' }}><Home size={14} /> Casa Eficiente</span></button>
              <button type="button" onClick={() => setFormData({ consumoMensual: '280', usoHorarioPico: 'false', cantidadEquipos: '4', tipoInmueble: 'Comercial', horasAltoConsumo: '4', metrosCuadrados: '90', cantidadPersonas: '3' })} style={presetBtnStyle}><span style={{ display: 'flex', alignItems: 'center', gap: '0.35rem' }}><Store size={14} /> Local Moderado</span></button>
